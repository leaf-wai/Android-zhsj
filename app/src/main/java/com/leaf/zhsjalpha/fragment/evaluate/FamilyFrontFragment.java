...
import com.leaf.zhsjalpha.databinding.FragmentFamilyFrontBinding;
...
public class FamilyFrontFragment extends Fragment {

    private FragmentFamilyFrontBinding binding;
    ...
    public static FamilyFrontFragment newInstance(View.OnClickListener listener) {
        FamilyFrontFragment fragment = new FamilyFrontFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        binding = FragmentFamilyFrontBinding.inflate(getLayoutInflater());
