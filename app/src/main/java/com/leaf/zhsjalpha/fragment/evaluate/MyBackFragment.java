...
public class MyBackFragment extends Fragment {
    ...
    private FragmentMyBackBinding binding;
        ...
        switch (v.getId()) {
            ...
            case R.id.ll_submit:
                if (submitUri != null) {
                    ...
                    mViewModel.customEvaluate(submitUri, String.valueOf(binding.etContent.getText()), 2, callback);
                }
                break;
        }
    };
    ...
    public static MyBackFragment newInstance(View.OnClickListener listener) {
        MyBackFragment fragment = new MyBackFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        binding = FragmentMyBackBinding.inflate(getLayoutInflater());
    ...
    private void openCamera() {
        PermissionX.init(MyBackFragment.this)
